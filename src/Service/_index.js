...
export class Service {
  ...
  getData = (params) => {
    ...
    // console.log(params);
    // console.log(Object.getOwnPropertyDescriptor(params, 'totalPrice'));

    for (const key in Object.getOwnPropertyDescriptors(params)) {
      const value = params[key];
      if ({}.hasOwnProperty.call(params, key)) {
        // if (key === 'totalPrice') {
        // console.log(value, value && value[Symbol.toStringTag], key);
        // }
      }
    }
